...
/project:file-issue camera freezes after error, see screenshot IMG_1234.png
```
...
4. **Index** - Run `./scripts/update_doc_index.py add` to track in doc-index
...
Follow the skill instructions exactly - including the **mandatory** doc-index update in step 4.
