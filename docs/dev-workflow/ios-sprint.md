...
4. **Execute Sprint**
   ...
   - Dispatch specialized subagents:
     ...
     - gcp-superpowers for Cloud Functions
...
| Task Type | Agent | MCP Servers |
|-----------|-------|-------------|
| iOS UI/Logic | ios-superpowers | sosumi.ai |
| Cloud Functions | gcp-superpowers | gcloud |
| Storage | gcp-superpowers | gcs |
| AI/Gemini | gemini-integration | gcloud |

## Prerequisites

- Spec document exists and is readable
- MCP servers configured (sosumi, gcloud, gcs, observability)
